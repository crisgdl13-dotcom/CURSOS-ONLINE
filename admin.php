...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['crear_curso'])) {
    ...
    $sql = "INSERT INTO cursos (nombre, instructor, precio, descripcion, imagen) VALUES (?, ?, ?, ?, ?)";
    $stmt = $pdo->prepare($sql);
    if ($stmt->execute([$nombre, $instructor, $precio, $descripcion, $imagen_final])) {
            ...
            <div class="col-md-4">
                <div class="card p-4">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label class="small">Opción 2: Pegar Enlace (URL)</label>
                            <input type="text" name="imagen_url" class="form-control form-control-sm" placeholder="https://google.com/imagen.jpg...">
                        </div>
                ...
                <div class="card p-4">
                    ...
                    <table class="table table-striped align-middle">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><img src="<?php echo $curso['imagen']; ?>" width="50" height="50" style="object-fit: cover; border-radius: 5px;"></td>
                                <td><?php echo htmlspecialchars($curso['nombre']); ?></td>
                                <td>$<?php echo $curso['precio']; ?></td>
                                <td>
                                    <a href="editar_curso.php?id=<?php echo $curso['id']; ?>" class="btn btn-sm btn-warning">✏️</a>
                                    <a href="borrar_curso.php?id=<?php echo $curso['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Estás seguro?');">🗑️</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
